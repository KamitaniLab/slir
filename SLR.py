...
class SparseLinearRegressor(BaseEstimator, ClassifierMixin):
    ...
    def fit(self, X, y):
        ...
        self.coef_[activate_index_orignal] = self.W # The coefficient of regression model 
        self.lambda_[activate_index_orignal] = self.A # The estimated precisions of weights(coefficient)
